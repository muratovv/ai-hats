"""Backlog layout contract + its integrator wiring (ADR-0014 P0 #2).
...
The dataclass moved here so it outlives the tracker package; a later change
stripped it to the two fields consumers actually read.
"""
