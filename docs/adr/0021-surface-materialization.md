...
- **runtime, claude — целевая форма с HATS-1268:** проводка сессии
  ...
  дал 19 ролей из 19 в обоих случаях. Разделяемый `bypass_journal` ship-ится
  копией рядом с каждым потребителем (оговорка к `bundle: dir`, ADR-0020 [3]
  D1). *Сегодня (до HATS-1480):* директория `library/hooks/` ещё пишется и ещё
