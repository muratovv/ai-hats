...
(`on_error`, ADR-0019 D4) — контракт вызывающего. Из трёх вызывающих сегодня
живы двое: wt-канал и git-оркестратор; rack-ребро —
*запланировано (HATS-1141)*.
...
| `checks:`              | `in_process` | схема и каталог точек — *реализовано (HATS-1140)*; исполнение — *запланировано (HATS-1141)*, снапшот-корень — *запланировано (HATS-1241)*; ADR-0019 D9 — корень собственный, никогда не провайдерский |
...
(ADR-0019 D9, *запланировано (HATS-1241)*) — корректны, а не запах:
