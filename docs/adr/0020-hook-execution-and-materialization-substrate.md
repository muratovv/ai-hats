...
- Долговечный артефакт — только **оркестратор**: по-событийный диспетчер
  ...
  **Это СТАБ, а не диспетчер (решение супервизора, ревью HATS-1337).** Файл
  ставится один раз и никогда не переустанавливается, поэтому каждая строка в
  нём — контракт с проектами, составленными годы спустя. Значит в нём не должно
