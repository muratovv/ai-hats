...
D2) реализован в своей ветке, ждёт мержа review→done. **HATS-1337
(оркестратор D3) реализован** — форк механизма резолва закрыт в пользу
live-резолва через интерпретатор, см. D3. Не начаты: HATS-1268
(claude runtime in place), HATS-1269 (wt in place),
