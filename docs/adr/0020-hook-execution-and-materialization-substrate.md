...
| `checks:`              | `in_process` | схема и каталог точек — *реализовано (HATS-1140)*; исполнение на рёбрах `edge:` — *реализовано (HATS-1141)*, снапшот-корень — *реализовано (HATS-1241)*; точки `card:`/`wt:` вызывающего ещё не имеют (ADR-0019 D3); ADR-0019 D9 — корень собственный, никогда не провайдерский |
...
собственный ai-hats-снапшот `checks/`
