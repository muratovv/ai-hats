...
| [how-to-extract-an-area.md](how-to-extract-an-area.md)   | Turning a folder into an area: the debt file, describing an interface, where a thing lives, the boundary gates                               | Maintainers; HATS-1586 epic      |
