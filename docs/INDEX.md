...
- **Step 2 — workspace**: [how-to-configure.md §1](how-to-configure.md#1-whats-in-ai-hatsyaml) (fields, incl. the `harness` source channel),
...
| [wt/overview.md](wt/overview.md)                         | Worktree architecture, L1-L4 locks, state layout, and lifecycle hooks                                                                        | Advanced / Worktree maintenance  |
| [wt/glossary.md](wt/glossary.md)                         | Dedicated glossary for worktree engine terms                                                                                                 | Advanced / Worktree maintenance  |
| [session-start-notices.md](session-start-notices.md)     | Startup-notice model, read-hold policy, provider settings lint                                                                               | Advanced                         |
...
| [migration-v0.15.0.md](migration-v0.15.0.md)             | Upgrade guide v0.14→v0.15 — Python 3.13 pin, role renames, rack arrow selectors, surfaces folded in                                          | Upgrading across a MAJOR bump    |
