...
Copied from ``packages/ai-hats-tracker/tests/test_ownership.py`` onto the
re-homed module (HATS-1258): the tracker copy dies with the package, this one
is the surviving coverage of claim/release/sweep/liveness.
...
from ai_hats.ownership import OwnershipRefused
