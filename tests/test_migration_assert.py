...
def _write_settings(
    ...
    *,
    ...
    target = claude_settings_local_json(project_dir) if local else claude_settings_json(project_dir)
...
def test_resolves_home_relative_path(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
