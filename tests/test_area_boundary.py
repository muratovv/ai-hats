...
# The second area (HATS-1826). Three of its five implementations still ship as separate
# distributions under packages/surfaces/, so today this name covers `claude` and `codex`:
