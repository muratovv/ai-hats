"""Pin `retro.intake.parse_intake_yaml` — create/merge happy paths and every reject branch.

Recovered from the deleted `packages/ai-hats-tracker` test suite (HATS-1264);
the module moved to the integrator side unchanged apart from docstrings.
"""
...
from ai_hats.retro.intake import (
    CreateAction,
    IntakeParseError,
    MergeAction,
    parse_intake_yaml,
