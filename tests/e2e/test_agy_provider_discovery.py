...
_SURFACE = "agy"
_DECLARED = "ai_hats.surfaces.agy.provider:AgyProvider"


def _declared_entry_point(repo_root: Path) -> str | None:
    """The real ``agy = ...`` declaration, read from the integrator's pyproject
...
def test_agy_surface_is_discovered_by_the_binary(ai_hats_shim: Path, repo_root: Path):
