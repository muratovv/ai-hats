...
# (~600 chars); acceptable budget for an always-on guard.
...
Long rationale → ADR / task card, linked by id — not pasted. A module docstring
states the contract in a few lines, not the design history.

## The 4-second test — run it before typing any comment
...
audit: findings 2a-F9 worktree.py 185-line docstring essay, 1-F3 providers.py
