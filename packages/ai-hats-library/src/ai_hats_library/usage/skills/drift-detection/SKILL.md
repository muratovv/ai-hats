...
1. **Extract requirements.** Acceptance Criteria from `task.yaml`, linked ADRs in `<ai_hats_dir>/tracker/decisions/`, GitHub Issue body, and any updates logged via `rack transition --log`.
